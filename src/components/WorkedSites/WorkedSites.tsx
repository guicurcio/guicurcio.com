...
/**
 * Props for the WorkedSites component.
 */
export interface WorkedSitesProps {
  /**
...
/**
 * WorkedSites Component
 */
export default function WorkedSites({
  className,
  name = "",
  position = "",
  imageURL = "",
...
WorkedSites.displayName = "WorkedSites";
