export const Hero = () => {
  return (
    <div className="w-[1050px] pt-[100px] mx-auto ">
      <div className="tracking-[-6px] mt-[15px] leading-[80px] font-SpaceGrotesk z-50 text-white">
        <p className="text-[80px] font-light text-left  text-opacity-[75%]">
          <span className="stroky2">Websites built by</span>
          <br></br>
